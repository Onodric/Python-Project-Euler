...
class Problem_001_Spec(unittest.TestCase):
    ...
    def test_happy_path(self):
        self.setup()
        self.assertEquals(self.problem.sum_of_multiples(10, 3, 5), 23)

    def test_null_path(self):
        self.setup()
        self.assertEquals(self.problem.sum_of_multiples(None, 3, 5), 0)
        self.assertEquals(self.problem.sum_of_multiples(30, None, 5), 0)
        self.assertEquals(self.problem.sum_of_multiples(30, 3, None), 0)
